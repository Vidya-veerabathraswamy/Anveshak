...
for i in range(len(path_coords)):
   lat_error = base_coords[i][0] - start_lat
   lon_error = base_coords[i][1] - start_lon
   corrected_lat = path_coords[i][0] - lat_error
   corrected_lon = path_coords[i][1] - lon_error
   corrected_coords.append([corrected_lat, corrected_lon])
